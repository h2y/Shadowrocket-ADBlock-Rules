...
\* 除了 [CloudGateRules](https://github.com/CloudGateRules/Shadowrocket) 是针对 SR 写的带广告过滤的规则，但是。。。1900+ 行的规则，这太臃肿了，耗电量会很可怕的。实际上该规则里面有超过一半是对一些黄色、赌博网站走代理的规则，而这些网站嘛，还是就让她们被墙着好了 -。-
